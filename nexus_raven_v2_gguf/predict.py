...
class Predictor(BasePredictor):
    def setup(self) -> None:
        self.model = Llama(model_path="./nexusraven-v2-13b.Q5_K_M.gguf", n_gpu_layers=-1, n_ctx=8192, n_threads=1, main_gpu=0)
